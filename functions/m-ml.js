...
async function scrapeAndWriteToGoogleSheet(numeroPaginaMaximo = 5) {
  ...
  try {
    ...
    const spreadsheetId = '1NV59_rbLXz3rpyuzg5Qc8PO6RmM377u2--dqvWAJAhg';

    // Navega a una página web
    await page.get('https://listado.mercadolibre.com.ar/ropa-accesorios/mujer/_Tienda_all');
